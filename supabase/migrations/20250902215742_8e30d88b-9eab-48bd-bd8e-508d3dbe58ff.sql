...
-- 1. Fix Security Definer View by dropping it and creating a regular view with proper RLS
...
-- Recreate trigger functions with proper search_path
...
-- Instead of a view, create a function that returns baby profile data safely
